...
指令：
& C:/Users/16544/anaconda3/envs/my-pytorch/python.exe main/predict_one.py --input_selfies "[C][C][=N][N][Branch1][Branch2][C][=Branch1][C][=O][N][Ring1][=Branch1][C][=C][C][=C][C][=C][Ring1][=Branch1][F]" --checkpoint "results/models/best model.pt"
